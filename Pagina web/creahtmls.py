...
for i in range(0,len(ip)):
  ...
  nombre_ned2.append('SDSS_' + ra_sex[i][:-3] + dec_sex[i][:-3])
  obs_muse[i] = obs_muse[i].replace('YES', '<a href="../imagenes/MUSE_RGB/' + nombre_ned2[i] + '.png">YES</a>')
  obs_meg[i] = obs_meg[i].replace('YES', '<a href="../imagenes/MEG_RGB/' + nombre_ned2[i] + '.png">YES</a>')
